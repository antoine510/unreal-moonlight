...
// This is the opaque Limelight context structure pointer
typedef struct _LIMELIGHT_CTX LIMELIGHT_CTX, *PLIMELIGHT_CTX;

// This function creates a streaming context
PLIMELIGHT_CTX LiCreateContext();

// This function destroys a streaming context
...
// network byte order.
int LiFindExternalAddressIP4(PLIMELIGHT_CTX ctx, const char* stunServer, unsigned short stunPort, unsigned int* wanAddr);
